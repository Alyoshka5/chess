...
class Chess
    ...
    def load_or_delete
        puts "Load a saved game by entering: load game_name / Delete a saved game by entering: delete game_name"
        puts "To see all currently saved games enter: list"
        puts "Press enter without inputing anything to load a new game"
        loop do
            puts "\nEnter command: "
